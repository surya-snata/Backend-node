...
// Middlewares are functions that have access to the `request(req)` and `response(res)`
// and the `next` function in express.js.
...
const logRequestDetails = require("./customMiddleware");
...
//   console.log("Hello from router-level middleware");
// });
